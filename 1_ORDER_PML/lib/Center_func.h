#ifndef CENTER_FUNC_H
#define CENTER_FUNC_H

#include "ShengShen_head.h"

//计算Vx,Vz
double center01_func(float **P_now,float **P_pre,float **P_aft,			     
...
//计算K
double center02_func(float **Vx_now,float **Vx_pre,float **Vx_aft,
				 float **K_now,float **K_pre,float **K_aft,
				 float **DEN,struct PARAMETER *param);	
				 
//计算Psa				 
double center03_func(float **K_now,float **K_pre,float **K_aft,
				 float **Psa_now,float **Psa_pre,float **Psa_aft,
				 float **absorbx,float **absorbz,struct PARAMETER *param);
				 
//计算Cita
double center04_func(float **Psa_now,float **Psa_pre,float **Psa_aft,
				 float **Cita_now,float **Cita_pre,float **Cita_aft,
				 float **absorbx,float **absorbz,struct PARAMETER *param);	
				 
//计算P
double center05_func(float **P_now,float **P_pre,float **P_aft,
