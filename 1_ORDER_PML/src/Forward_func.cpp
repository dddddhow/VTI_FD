...
double forward_func(struct PARAMETER *param)
{
    ...
    for(i=0;i<param->PML;i++)
    {
        for(j=0;j<param->Nz;j++)
        {
            absorbx[i][j]=3.0*V[i][j]*1.0/(2.0*param->PML)*log(1.0/0.001)
                *pow(((param->PML-i)*1.0/param->PML),4);
        }
    }
    //右边界//
    for(i=param->NX+param->PML;i<param->Nx;i++)
    {
        ...
        {
            absorbx[i][j]=3.0*V[i][j]*1.0/(2.0*param->PML)*log(1.0/0.001)
                *pow(((i - param->NX - param->PML)*1.0/param->PML),4);
        }
    }
    //上边界//
    for(i=0;i<param->Nx;i++)
    {
        for(j=0;j<param->PML;j++)
        {
            absorbz[i][j]=3.0*V[i][j]*1.0/(2.0*param->PML)*log(1.0/0.001)
                *pow(((param->PML-j)*1.0/param->PML),4);
        }
    }
    //下边界//
    for(i=0;i<param->Nx;i++)
    {
        ...
        {
            absorbz[i][j]=3.0*V[i][j]*1.0/(2.0*param->PML)*log(1.0/0.001)
                *pow(((j - param->NZ - param->PML)*1.0/param->PML),4);
        }
    }
            ...
            param->nx_location=param->nx_location+ds)
    {
        ...
        for(k=0; k<param->Nt; k++) //波场时间递推计算开始
        {
            ...
            //PART01 :VX VZ
            //左边//
            left01_func(P_now,P_pre,P_aft,                  
                    Vx_now,Vx_pre,Vx_aft,
                    Vz_now,Vz_pre,Vz_aft,
                    DEN,absorbx,absorbz,param);			

            //中间
            center01_func(P_now,P_pre,P_aft,                  
                    Vx_now,Vx_pre,Vx_aft,
                    Vz_now,Vz_pre,Vz_aft,
                    DEN,absorbx,absorbz,param);
            //右边//
            right01_func(P_now,P_pre,P_aft,                  
                    Vx_now,Vx_pre,Vx_aft,
                    Vz_now,Vz_pre,Vz_aft,
                    DEN,absorbx,absorbz,param);
            //上边//
            up01_func(P_now,P_pre,P_aft,                  
                    Vx_now,Vx_pre,Vx_aft,
                    Vz_now,Vz_pre,Vz_aft,
                    DEN,absorbx,absorbz,param);
            //下边//
            under01_func(P_now,P_pre,P_aft,                  
                    Vx_now,Vx_pre,Vx_aft,
                    Vz_now,Vz_pre,Vz_aft,
                    DEN,absorbx,absorbz,param);
            ...
            //PART02 :K
            //左边//
            left02_func(Vx_now,Vx_pre,Vx_aft,                  
                    K_now,K_pre,K_aft,
					DEN,param);
            //中间
            center02_func(Vx_now,Vx_pre,Vx_aft,                  
                    K_now,K_pre,K_aft,
					DEN,param);
            //右边//
            right02_func(Vx_now,Vx_pre,Vx_aft,                  
                    K_now,K_pre,K_aft,
					DEN,param);
            //上边//
            up02_func(Vx_now,Vx_pre,Vx_aft,                  
                    K_now,K_pre,K_aft,
					DEN,param);
            //下边//
            under02_func(Vx_now,Vx_pre,Vx_aft,                  
                    K_now,K_pre,K_aft,
					DEN,param);

            //PART03 :Psa
            //左边//
            left03_func(K_now,K_pre,K_aft,
                    Psa_now,Psa_pre,Psa_aft,
					absorbx,absorbz,param);
            //中间
            center03_func(K_now,K_pre,K_aft,
                    Psa_now,Psa_pre,Psa_aft,
					absorbx,absorbz,param);
            //右边//
            right03_func(K_now,K_pre,K_aft,
                    Psa_now,Psa_pre,Psa_aft,
					absorbx,absorbz,param);
            //上边//
            up03_func(K_now,K_pre,K_aft,
                    Psa_now,Psa_pre,Psa_aft,
					absorbx,absorbz,param);
            //下边//
            under03_func(K_now,K_pre,K_aft,
                    Psa_now,Psa_pre,Psa_aft,
					absorbx,absorbz,param);

            //PART04 :Cita
            //左边//
            left04_func(Psa_now,Psa_pre,Psa_aft,
                    Cita_now,Cita_pre,Cita_aft,
                    absorbx,absorbz,param);
            //中间
            center04_func(Psa_now,Psa_pre,Psa_aft,
                    Cita_now,Cita_pre,Cita_aft,
                    absorbx,absorbz,param);
            //右边//
            right04_func(Psa_now,Psa_pre,Psa_aft,
                    Cita_now,Cita_pre,Cita_aft,
                    absorbx,absorbz,param);
            //上边//
            up04_func(Psa_now,Psa_pre,Psa_aft,
                    Cita_now,Cita_pre,Cita_aft,
                    absorbx,absorbz,param);
					
            //下边//
            under04_func(Psa_now,Psa_pre,Psa_aft,
                    Cita_now,Cita_pre,Cita_aft,
                    absorbx,absorbz,param);

            //PART05 :Px Pz P
            //左边//
            left05_func(P_now,P_pre,P_aft,
                    ...
                    wavelet);
            //中间
            center05_func(P_now,P_pre,P_aft,
                    Px_now,Px_pre,Px_aft,
                    Pz_now,Pz_pre,Pz_aft,
                    Vz_now,Vz_pre,Vz_aft,
                    K_now,K_pre,K_aft,
                    ...
                    wavelet);
            //右边//
            right05_func(P_now,P_pre,P_aft,
                    Px_now,Px_pre,Px_aft,
                    Pz_now,Pz_pre,Pz_aft,
                    Vz_now,Vz_pre,Vz_aft,
                    K_now,K_pre,K_aft,
            ...
            up05_func(P_now,P_pre,P_aft,
                    ...
                    wavelet);
            //下边//
            under05_func(P_now,P_pre,P_aft,
                    Px_now,Px_pre,Px_aft,
                    Pz_now,Pz_pre,Pz_aft,
                    Vz_now,Vz_pre,Vz_aft,
                    K_now,K_pre,K_aft,
