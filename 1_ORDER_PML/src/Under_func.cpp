...
double under02_func(float **Vx_now,float **Vx_pre,float **Vx_aft,
...
double under03_func(float **K_now,float **K_pre,float **K_aft,
...
double under04_func(float **Psa_now,float **Psa_pre,float **Psa_aft,
