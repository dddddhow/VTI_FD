...
double left01_func(float **P_now,float **P_pre,float **P_aft,			     
...
double left02_func(float **Vx_now,float **Vx_pre,float **Vx_aft,
...
double left03_func(float **K_now,float **K_pre,float **K_aft,
...
double left04_func(float **Psa_now,float **Psa_pre,float **Psa_aft,
...
double left05_func(float **P_now,float **P_pre,float **P_aft,
